...
from app.postprocessing import autocorrect_name, clean_num, postprocess_parsed_data
...
def test_postprocess_parsed_data():
    ...
    parsed_data = ParsedData(
        supplier="ООО Тест", date="2025-01-01", positions=[position], total_price=1500.0
    )
