...
from app.edit.apply_intent import apply_intent, set_date, set_price
...
def test_apply_intent_price():
    ...
    intent = {"action": "set_price", "line_index": 0, "value": "95000"}
...
def test_apply_intent_date():
    ...
    intent = {"action": "set_date", "value": "2025-04-16"}
