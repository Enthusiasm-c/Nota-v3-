            ...
            with patch('app.assistants.client.ASSISTANT_ID', 'dummy_id'):
                ...
                with patch('app.handlers.edit_flow.run_thread_safe') as mock_assist:
                    ...
                    with patch('app.data_loader.load_products') as mock_load:
                        ...
                        assert any("Наверное, вы имели в виду" in text and "Apple" in text for text in answer_calls)
                        ...
                        assert any(
                            'fuzzy_original' in call.kwargs and call.kwargs['fuzzy_original'] == 'aple'
                            and 'fuzzy_match' in call.kwargs and call.kwargs['fuzzy_match'] == 'Apple'
