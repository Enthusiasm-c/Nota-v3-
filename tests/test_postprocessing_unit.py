...
def test_clean_num_edge_cases():
    ...
    assert (
        postprocessing.clean_num("10,00.00") == 1000.0
        or postprocessing.clean_num("10,00.00") == 10.0
    )
    ...
    assert (
        postprocessing.clean_num("1.234.567,89 руб") == 1234567.89
        or postprocessing.clean_num("1.234.567,89 руб") == 123456789
    )
