...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "изменить поставщика на ИП Иванов",
            [
                {
                    "action": "unknown",
                    "error": "unknown_command",
                    "original_text": "изменить поставщика на ИП Иванов",
                    "source": "integrated_parser",
                }
            ],
        ),  # Free parser handles supplier
            ...
            [
                {
                    "action": "unknown",
                    "error": "unknown_command",
                    "original_text": "общая сумма 12345",
                    "source": "integrated_parser",
                }
            ],
        ...
        (
            "строка 2 название Сметана",
            [{"action": "edit_name", "line": 1, "value": "Сметана", "source": "local_parser"}],
        ),
        (
            "строка 1 количество 5",
            [{"action": "edit_quantity", "line": 0, "value": 5.0, "source": "local_parser"}],
        ),
        (
            "изменить количество в строке 3 на 2,5",
            [{"action": "edit_quantity", "line": 2, "value": 2.5, "source": "local_parser"}],
        ),
        # Обработка дробных чисел и разных форматов
        (
            "строка 1 количество 1,5",
            [{"action": "edit_quantity", "line": 0, "value": 1.5, "source": "local_parser"}],
        ),
        (
            "строка 1 количество 2.75",
