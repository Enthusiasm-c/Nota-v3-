...
def main():
    ...
    parser.add_argument("--repeat", "-r", type=int, default=1, help="Количество повторов для тестирования кеша")
    ...
    for i in range(args.repeat):
        ...
        try:
            ...
            if args.output or i == 0:
                output_path = args.output or os.path.join(results_dir, f"ocr_result_{int(time.time())}.json")
