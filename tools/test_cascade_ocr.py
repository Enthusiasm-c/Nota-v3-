...
def generate_stats(result):
    ...
    stats = {
        ...
        'confidence_distribution': {
            'very_low_percent': (confidence_stats['very_low'] / total_cells * 100) if total_cells else 0,
            ...
            'very_high_percent': (confidence_stats['very_high'] / total_cells * 100) if total_cells else 0,
        },
        'accuracy': result.get('accuracy', 0),
